...
- (void)viewDidLoad {
    ...
    DrawBurgerChoices *drawBurgerChoices = [[[DrawBurgerChoices alloc] initWithFrame:CGRectMake(self.view.frame.size.width * 0.1, self.view.frame.size.height * 0.4, self.view.frame.size.width * 0.8, self.view.frame.size.width * 0.8)] autorelease];
//    drawView.backgroundColor = [UIColor clearColor];
    drawBurgerChoices.backgroundColor = [UIColor blueColor];
    ...
    [self.view addSubview:drawBurgerChoices];
