...
class ShowImageAnimator: NSObject, UIViewControllerAnimatedTransitioning {
    ...
    func animateTransition(transitionContext: UIViewControllerContextTransitioning) {
        ...
        let fromViewController = transitionContext.viewControllerForKey(UITransitionContextFromViewControllerKey) as UserCollectionVC
        let toViewController = transitionContext.viewControllerForKey(UITransitionContextToViewControllerKey) as SingleUserVC
        ...
        toViewController.singleUserImageView.frame = toViewController.view.bounds
