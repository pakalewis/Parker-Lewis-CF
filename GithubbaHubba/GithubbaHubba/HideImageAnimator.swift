...
class HideImageAnimator: NSObject, UIViewControllerAnimatedTransitioning {
    ...
    func animateTransition(transitionContext: UIViewControllerContextTransitioning) {
        let fromViewController = transitionContext.viewControllerForKey(UITransitionContextFromViewControllerKey) as SingleUserVC
        let toViewController = transitionContext.viewControllerForKey(UITransitionContextToViewControllerKey) as UserCollectionVC
        ...
        UIView.animateWithDuration(1.0, delay: 0.0, options: nil, animations: { () -> Void in
            ...
            fromViewController.singleUserImageView.frame = fromViewController.view.bounds
